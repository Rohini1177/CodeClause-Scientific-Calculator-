...
class SCalculator {
    ...
    private void initialize() {
        ...
        frmCalculator.getContentPane().setBackground(new Color(99, 119, 108));
        // frmCalculator.setIcon(new ImageIcon("G:\\JavaApp\\A1\\src\10177.jpg"));
        // frmCalculator.getContentPane().add(frmCalculator);
        ...
        textPanel.setBounds(34, 25, 320, 80);
        ...
        textField.setBounds(2, 30, 310, 40);
        ...
        butttonPanel.setBounds(34, 120, 320, 322);
        frmCalculator.getContentPane().add(butttonPanel);
        butttonPanel.setLayout(new GridLayout(0, 5, 2, 2));
        ...
        JButton button10 = new JButton(/* "<html><body><span>√</span></body></html>" */ "Sqrt");
        ...
        button10.setFont(new Font("Calibri Light", Font.PLAIN, 16));
        ...
        JButton button29 = new JButton("Ans");
        ...
        /*
         * JButton button31 = new JButton("Sqrt");
         * button31.addActionListener(new ActionListenner());
         */
    }
}
